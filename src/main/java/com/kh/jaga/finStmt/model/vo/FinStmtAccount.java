...
@Component
public class FinStmtAccount implements java.io.Serializable {
	...
	public FinStmtAccount() {}
	
	public FinStmtAccount(String comCode, int accountCode, ArrayList accountArr, String accountTitle, String curPast,
