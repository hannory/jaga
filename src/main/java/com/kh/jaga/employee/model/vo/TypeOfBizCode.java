...
public class TypeOfBizCode {
	...
	public TypeOfBizCode() {}
	
	public TypeOfBizCode(String typeOfBizCode, String sellWayName, String sellTargetName, int tobcPkCode) {
		super();
	...
	public String toString() {
		return "TypeOfBizCode [typeOfBizCode=" + typeOfBizCode + ", sellWayName=" + sellWayName + ", sellTargetName="
