...
<td>
<b id="name"> 이름</b>
<input type="text" id="name-surr"> 
<b id="security-num">주민등록번호</b>
<input type="text" id="security-num-surr">
</td>
</tr>
...
<td>
<b id="salary">월급여</b>
<input type="text" id="salary-surr">
<b id="email">이메일</b>
<input type="text" id="email-surr">
</td>
</tr>
...
<input type="text" id="enroll-date-surr">
</td>
</tr>
...
<input type="text" id="a-status-surr">
<b id="zero-one-1">0:부 1:여</b>
</td>
</tr>
...
<input type="text" id="de-status-surr">
<b id="zero-one-2">1:부 0:여</b>
</td>
</tr>
...
<input type="text" id="account-num-surr">
</td>
</tr>
...
<input type="text" id="account-holder-surr">
<b id="department">부서</b>
<input type="text" id="department-surr">
</td>
</tr>
...
<input type="text" id="position-code-surr">
</td>
</tr>
...
<input type="file" id="id-docu1-surr">
...
<input type="file" id="account-docu-surr">
